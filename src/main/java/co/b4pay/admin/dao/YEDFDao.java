 ...
 */
@MyBatisDao
public interface YEDFDao extends ICrudDao<YEDFPayroll> {
    //查询分账总金额
    ...
    List<YEDFPayroll> findByDerived(HashMap<String, Object> map);

    List<YEDFPayroll> selFind(Map<String, Object> map);

    int selFindCount(String id);

    String findAdminChannel(String id);

    Page<YEDFPayroll> findListCount(Page<YEDFPayroll> page);
