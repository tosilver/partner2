...
public class HttpClientQueryUtil {
    public static String post(String publicKeyIndex, String signAlgorithm, String merchantNo, String inputCharset, String url, String signature, String batchNo, String payMerchantNo)
