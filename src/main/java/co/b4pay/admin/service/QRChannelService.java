...
@Service
@Transactional
public class QRChannelService extends CrudService<QRChannelDao, QRChannel> {
    @Autowired
    ...
    public int updateRechargeAmount(String id,BigDecimal rechargeAmount){
        QRChannel qrChannel = dao.get(id);
        BigDecimal rechargeAmount1 = qrChannel.getRechargeAmount();
        BigDecimal sum =null;
