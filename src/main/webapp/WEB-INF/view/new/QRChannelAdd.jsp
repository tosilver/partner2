...
<div id="wrap">
    ...
    <div class="primary">
        <h1>通道新增</h1>
        <form action="${ctx}/QRChannel/save" method="get" class="col_form">
            ...
            <div class="form_div">
                <label>通道名称</label>
                <input type="text" class="add" name="name"/>
            </div>
            <br/>
            <div class="form_div">
                <label>通道速率</label>
                <input type="text" class="add" name="rate"/>
            </div>
            <br/>
            <div class="form_div">
                <button type="submit">提交</button>
                <button type="button" id="select" onclick="javascript:history.back(1);">返回</button>
            </div>
        </form>
    </div>
</div>
